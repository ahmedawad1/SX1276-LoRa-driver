...
// These registers will be modified when using the other functions setmode , setpowerON ... This is only initialization
	...
	writeRegister(0x1D,0x82); // RegModemConfig1 (SignalBW + ErrorCodingRate + Explicit/Implicit Hader mode)
...
/*
 ...
 Parameters:
 * 
 * SX1276 has many Bandwidth defined more than SX1272 to reach longer reaches but with very slow data rate
 * However, the 10 modes defined by Libelium will be used in SX1276 
...
*/
// For SX1276 the PA_BOOST is used on the Modtronix inAir9B modules 
